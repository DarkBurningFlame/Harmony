...
namespace Flames.Cli {
    public static class Program {
        ...
        public static void Main(string[] args) {
            ...
            // If Harmony_.exe is missing, a FileNotFoundException will get thrown for Harmony_ executable
            try
            {
                EnableCLIMode();
        ...
        static void EnableCLIMode() {
            try {
                ...
                // in case user is running CLI with older Harmony exe which lacked CLIMode field
            }
