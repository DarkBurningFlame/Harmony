...
You probably want to go to the Actions page and get the latest zip from there.

However, you can still download the required files from here. You need these files:
Harmony.exe, Harmony_.exe

This version of Flames is being developed to have backwards compatibility with the other cores: 
